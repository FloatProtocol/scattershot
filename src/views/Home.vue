...
const scattershotSpotlight = [
  'snapshot.floatprotocol.eth', // Cheeky I know, but it is good to be bold.
  'idlefinance.eth', // Spotted a bug with displaying vote choices, so a little thank you.
  ...spotlight
];
